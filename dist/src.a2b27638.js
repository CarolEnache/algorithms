...
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~custom Generator function where we dynamically generate values into the object and iterate over them');

var numbers = _defineProperty({}, Symbol.iterator,
/*#__PURE__*/
  ...
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _ref = _args.length > 0 && _args[0] !== undefined ? _args[0] : {}, _ref$start = _ref.start, start = _ref$start === void 0 ? 0 : _ref$start, _ref$end = _ref.end, end = _ref$end === void 0 ? 100 : _ref$end, _ref$step = _ref.step, step = _ref$step === void 0 ? 1 : _ref$step;
          i = start;
...
console.log("My lucky numbers are: ".concat(_toConsumableArray(numbers[Symbol.iterator]({
  start: 6,
  end: 30,
  step: 4
}))));
